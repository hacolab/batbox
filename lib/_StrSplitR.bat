...
REM - USAGE  ) call _StrSplitR SourceStr SepChar ArrName
REM - Exmpl  ) call _StrSplitR "A:B:C" : R -> R[1]=A:B R[2]=C R.Len=2
REM - Exmpl  ) call _StrSplitR "A:B:C" D R -> R[1]= R[2]= R.Len=0
REM - IN/OUT )
