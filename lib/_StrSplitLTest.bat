...
call _AryNew TestExpect1L "" "\C" "\C:\path\," ""
call _AryNew TestExpect1R "C:\path\, dir\" "\path\, dir\" "dir\" ""
call _AryNew TestExpect1Len 2 2 2 0

for /l %%i in (1, 1, %TestData1.Len%) do (
    call _StrSplitL %SrouceText% !TestData1[%%i]! retAry
